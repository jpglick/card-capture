...
def side_accuracy(*, db_path: Path, truth_path: Path, video_id: str) -> MetricResult:
    ...
    Returns
    -------
    MetricResult with value in [0, 1], or value=None when there are no matched detections.
    """
    ...
    return MetricResult(value=correct / len(matched))
